...
if len(sys.argv)!=5:
        print "Usage: python scripts.py results.filtered.file output_confFuse_file artefact_list gencode.v19.annotation.gtf"
        sys.exit(0)

#defuseFolder=sys.argv[1]
#outputFolder=sys.argv[2]
defuseFile=sys.argv[1]
...
with open(defuseFile,'r') as file_:
